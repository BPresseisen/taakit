...
const VitalSchema = new Schema({
  ...
  //NERVE PAIN VITALS QUESTION
   nPain: {type: Number, required: false},
  //OTHER PAIN (ex: SWELLING) VITALS QUESTION
  ...
  bTemp: {type: Number, required: false},
  ...
  //VITAL SCORE
  vitalScore: {type: Number, required: false},
  //MEMO
...
const Vital = mongoose.model("Task", VitalSchema);
